...
export default function Login(){
    return(
        <div style={{backgroundColor: '#f3f4f6',fontFamily:"Sans-Serif",fontSize:'1.2rem',height: 900, }}>
            ...
            <Box sx={{ maxWidth: 500,backgroundColor: '#ffffff'}} mx="auto" p="lg">
                <form>
                    ...
                    <Group mt="xs">
                        <Button 
                            sx={{ backgroundColor: 'black' ,width: 500,height:50,padding: '0.5rem',fontSize:'1rem',margin: '0.5rem'}}
                            type="submit"
                            >
                    ...
                    <Group sx={{padding: '1rem'}}>
                        <Button
                            sx={{ color:'black',backgroundColor:'white', width: 500,height:40,padding: '0.3rem',fontSize:'0.8rem', border: '1px solid gray'}}
